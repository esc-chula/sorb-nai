...
RUN --mount=type=cache,id=s/47e73ea7-2d5b-4026-95f2-3fc27cfcf0e9-/pnpm/store,target=/pnpm/store pnpm install
...
RUN --mount=type=cache,id=s/47e73ea7-2d5b-4026-95f2-3fc27cfcf0e9-/app/node_modules/.vite,target=/app/node_modules/.vite pnpm run build
